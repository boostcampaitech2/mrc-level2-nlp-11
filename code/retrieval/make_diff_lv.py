...
class SparseRetrieval:
    ...
    def get_relevant_doc_bulk(
        self, queries: List, k: Optional[int] = 20
    ) -> Tuple[List, List]:
    ...
    def retrieve_faiss(
        ...
        if isinstance(query_or_dataset, str):
            ...
            return (doc_indices, doc_scores, [self.contexts[doc_indices[i]] for i in range(topk)])
...
data_to_save.to_pickle("../../data/difficult_sparse_docs.pkl")
