...
def main_fun(args):
    ...
    data_to_save = pd.DataFrame(
        listform, columns=["id", "question", "docs_id", "ans_id"]
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--datapath", default="../../data", type=str, help="")
    parser.add_argument("--wiki", default="wikipedia_documents.json", type=str, help="")
    parser.add_argument(
        "--tokenizer", default="klue/bert-base", type=str, help=""
